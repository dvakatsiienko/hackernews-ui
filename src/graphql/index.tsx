...
export type MutationKeySpecifier = ('createPost' | 'deletePost' | 'login' | 'signup' | 'unVote' | 'updatePost' | 'vote' | MutationKeySpecifier)[];
...
export type QueryKeySpecifier = ('authenticate' | 'feed' | 'post' | 'user' | QueryKeySpecifier)[];
