...
export async function getServerPageAuthenticate(
    options: Omit<
        Apollo.QueryOptions<Types.AuthenticateQueryVariables>,
        'query'
    >,
    ctx?: any,
) {
    ...
    const data = await apolloClient.query<Types.AuthenticateQuery>({
        ...options,
        query: Operations.AuthenticateDocument,
    });
...
export const useAuthenticate = (
    optionsFunc?: (
        ...
        Types.AuthenticateQuery,
        Types.AuthenticateQueryVariables
    >,
) => {
...
export type PageAuthenticateComp = React.FC<{
    data?: Types.AuthenticateQuery;
...
export async function getServerPageFeed(
    options: Omit<Apollo.QueryOptions<Types.FeedQueryVariables>, 'query'>,
    ctx?: any,
) {
    const apolloClient = getApolloClient(ctx);

    const data = await apolloClient.query<Types.FeedQuery>({
        ...options,
...
export const useFeed = (
    optionsFunc?: (
        router: NextRouter,
    ) => QueryHookOptions<Types.FeedQuery, Types.FeedQueryVariables>,
) => {
    const router = useRouter();
    const options = optionsFunc ? optionsFunc(router) : {};
    return useQuery(Operations.FeedDocument, options);
};
export type PageFeedComp = React.FC<{
    data?: Types.FeedQuery;
    error?: Apollo.ApolloError;
}>;
...
export async function getServerPagePostCreated(
    options: Omit<
        Apollo.QueryOptions<Types.PostCreatedSubscriptionVariables>,
        'query'
    >,
    ctx?: any,
) {
    ...
    const data = await apolloClient.query<Types.PostCreatedSubscription>({
        ...options,
        query: Operations.PostCreatedDocument,
    });
...
export const usePostCreated = (
    optionsFunc?: (
        ...
        Types.PostCreatedSubscription,
        Types.PostCreatedSubscriptionVariables
    >,
) => {
    const router = useRouter();
    const options = optionsFunc ? optionsFunc(router) : {};
...
export type PagePostCreatedComp = React.FC<{
    data?: Types.PostCreatedSubscription;
    error?: Apollo.ApolloError;
}>;
...
export async function getServerPagePostVoted(
    options: Omit<
        Apollo.QueryOptions<Types.PostVotedSubscriptionVariables>,
        'query'
    >,
    ctx?: any,
) {
    ...
    const data = await apolloClient.query<Types.PostVotedSubscription>({
        ...options,
        query: Operations.PostVotedDocument,
    });
...
export const usePostVoted = (
    optionsFunc?: (
        ...
        Types.PostVotedSubscription,
        Types.PostVotedSubscriptionVariables
    >,
) => {
    const router = useRouter();
    const options = optionsFunc ? optionsFunc(router) : {};
...
export type PagePostVotedComp = React.FC<{
    data?: Types.PostVotedSubscription;
    error?: Apollo.ApolloError;
}>;
